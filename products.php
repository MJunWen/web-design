...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="rightcolumn">
            ...
            <div class="addtocart">
            <?php if ($product_quantity[0] <= 0)  {
                    echo "<a>Sold out</a>";
                } else if (isset($product_id[0])) {
                    echo " <a href='" . $_SERVER['PHP_SELF'] . '?buy=' . $product_id[0] . "'>Buy</a>";
                }?>
            </div>

            <div class="addtocart">
            <?php if ($product_quantity[1] <= 0)  {
                    echo "<a>Sold out</a>";
                } else if (isset($product_id[1])) {
                    echo " <a href='" . $_SERVER['PHP_SELF'] . '?buy=' . $product_id[1] . "'>Buy</a>";
                }?>
            </div>

            <div class="addtocart">
            <?php if ($product_quantity[2] <= 0)  {
                    echo "<a>Sold out</a>";
                } else if (isset($product_id[2])) {
